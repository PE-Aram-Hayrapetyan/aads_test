 ...
 * Search for friends
 */
export const postUsersDashboardFriendsSearch = <ThrowOnError extends boolean = false>(options?: Options<PostUsersDashboardFriendsSearchData, ThrowOnError>) => { return (options?.client ?? client).post<PostUsersDashboardFriendsSearchResponse, PostUsersDashboardFriendsSearchError, ThrowOnError>({
    ...options,
    url: '/users/dashboard/friends/search'
}); };